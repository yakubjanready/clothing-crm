...
| domain__faza22__04-live-https.png      | 22 | tls_domain | **Live tasdiq**: https://negative.uz 200 OK, HSTS+X-Frame-Options+X-Content-Type-Options qaytmoqda; http -> 301 https redirect ishlaydi; /api/v1/ping JSON qaytaradi. Tezkor tuzatish: options-ssl-nginx.conf dependency olib tashlandi (inline ssl_protocols+ciphers), init-letsencrypt.sh standalone rejimga o'zgartirildi (sudo kerak emas) |
